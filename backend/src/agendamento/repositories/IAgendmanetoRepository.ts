...
interface IAgendamentoRepository extends IBaseRepository {
  ...
  SearchByPeriodAsync(parametroPeriodoAgendamento: ParametroPeriodoAgendamento, blocoId: string, laboratorioId: string, laboratorioNome: string, data: number): Promise<Agendamento[]>;
};
