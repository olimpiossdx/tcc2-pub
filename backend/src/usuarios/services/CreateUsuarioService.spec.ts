...
describe('Criar usuário', () => {
  ...
  it('Não é possível criar ususário com mesmo cartão de acesso.', async () => {
    await createUsuarioService.execute({ id: '1425368188', nome: 'teste', email: 'teste1@email.com', acessKey: 'teste-key', urlImg: 'http://teste.com' });

    await expect(createUsuarioService.execute({ id: '1425368189', nome: 'teste', email: 'teste@email.com', acessKey: 'teste-key', urlImg: 'http://teste.com' })).rejects.toBeInstanceOf(AppError);
  });
});
